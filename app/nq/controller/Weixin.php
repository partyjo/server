...
class Weixin extends Base
{
    ...
    public function isLoginTest($url) {
        ...
        $this->data['code'] = 9999;
        $this->data['data'] = 'http://partyjo.nextdog.cc/server/nq/weixin/wxOauthBackTest?url='.$url;
        return $this->ajax($this->data);
    }
    ...
    public function getOauthUrl($url)
    {
        ...
        $wxOauthUrl = 'http://partyjo.nextdog.cc/server/nq/weixin/wxoauthback?url='.$url;
        return $weObj->getOauthRedirect($wxOauthUrl,'nq');
    }
    ...
    {
        session('NN_OAUTH_INFO',$token);
    }

    protected function getToken()
    {
        return session('NN_OAUTH_INFO');
    }
